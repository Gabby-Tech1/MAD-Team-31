  ...
  List<NotificationItem> _getNotifications() {
    return [
      ...
      NotificationItem(
        ...
        message: 'Your payment of \$12.50 for 2 hours parking has been processed successfully.',
      ...
      NotificationItem(
        ...
        message: 'You have 15 minutes remaining for your parking at Ocean View Lot.',
      ...
      NotificationItem(
        id: '4',
        title: 'Special Offer',
        message: 'Get 25% off your next parking booking at any Downtown location.',
